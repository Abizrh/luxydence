...
const textChart = 'Total new customer & existing customer this month'
    ...
    <div class="tw-mb-6 tw-mt-0 tw-flex tw-justify-between">
      ...
      <div class="tw-flex tw-gap-3">
        <div class="tw-flex tw-items-center tw-gap-1">
          ...
          <span class="tw-text-[12px] tw-font-normal">New Customer</span>
        </div>
        <div class="tw-flex tw-items-center tw-gap-1">
          <div class="tw-h-[12px] tw-w-[12px] tw-rounded-full tw-bg-[#FFE8DE]"></div>
          <span class="tw-text-[12px] tw-font-normal">Existing Customer</span>
        </div>
      </div>
    </div>
